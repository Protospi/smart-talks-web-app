export default {
  ...
  'hero.titleHighlight1': 'sell',
  'hero.titleHighlight2': 'enchant',
  'hero.titleHighlight3': 'resolve',
  ...
  'footer.copyright': 'SmartTalks.ai All rights reserved.',
  'about.hero.label': 'About Us',
  'about.section.label': 'ABOUT US',
  'about.section.title': 'Guide121 is now',
  'about.section.titleHighlight': 'SmartTalks',
  'about.section.description': 'Understand the change. We are building a future where technology not only facilitates but transforms relationships between brands and their customers.',
  'about.section.description2': 'Together, we will end the era of chatbots and usher in a new era of intelligent conversations.',
  'about.values.label': 'FUNDAMENTAL VALUE',
  'about.values.title': 'Revealing our',
  'about.values.titleHighlight': 'fundamental values',
  'about.values.subtitle': 'for lasting impact.',
  'about.values.mission.title': 'Mission',
  'about.values.mission.description': 'Connect brands and people in an intelligent and functional communication environment.',
  'about.values.vision.title': 'Vision',
  'about.values.vision.description': 'Become the world\'s leading provider of intelligent conversation solutions.',
  'about.values.values.title': 'Values',
  'about.values.values.description': 'Become the world\'s leading provider of intelligent conversation solutions.',
  'about.ceo.label': 'TRANSFORMATION',
  'about.ceo.title': 'Welcome to the era of',
  'about.ceo.titleHighlight': 'intelligent conversations!',
  'about.ceo.description1': 'After 8 years of operation focusing on the tourism, entertainment, and hospitality sectors, we sought an inflection point that reflects current market transformations and leverages our growth.',
  'about.ceo.description2': 'We live in a time of rapid evolution, driven by Generative Artificial Intelligence, which is revolutionizing how we communicate and interact. According to data from the Brazilian Chatbot Map, the market is at a saturation point, with over 670,000 chatbots created, and many of them still don\'t deliver the desired experience. Given this scenario, we decided it was time to evolve and reposition our brand.',
